import { GuildMember, type MessageCreateOptions } from "discord.js";
...
export declare const buildWelcomeMessage: ({ member, config, memberIndex, }: BuildWelcomeMessageOptions) => MessageCreateOptions;
